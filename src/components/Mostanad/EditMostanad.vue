  ...
  <div class="grid lg:grid-cols-12 gap-4">
    ...
    >
      ...
      >
        ...
        >
          از این بخش می توانید مستند را بروزرسانی کنید
        </p>
      </div>
                    ...
                    <div class="relative col-span-6 mt-4">
                      ...
                      <div class="mt-1 rounded-md">
                        ...
                        >
                          ...
                          <TagInput ref="tagInputRef" :modelValue="mostanadInfo.keywords" v-model="mostanadData.keywords"></TagInput>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <aside class="lg:col-span-3 col-span-12">
      <div class="sticky top-24">
        ...
        <div class="flex items-center w-full p-4 border-b border-gray-200">
          ...
          ><span>بروزرسانی مستند </span>
        </div>
        <div class="block p-4">
          <button
            type="button"
            @click="loading == false ? editMostanadData() : ''"
          ...
          >
            ...
            ><span
              ...
              ><span class="w-full">
                ...
                <span v-else>بروزرسانی مستند </span>
              </span></span
            >
          </button>
          <button
...
export default {
  ...
  async mounted(){
    ...
    if(this.mostanadInfo != null){
      this.mostanadData.id = this.mostanadInfo.id
      this.mostanadData.title = this.mostanadInfo.title
      this.mostanadData.slug = this.generateSlug(this.mostanadInfo.title);
      this.mostanadData.date = this.mostanadInfo.date.split('-').join('/')

      this.mostanadData.content = this.mostanadInfo.content
      this.mostanadData.summary_description = this.mostanadInfo.summary_description
      this.mostanadData.meta_title = this.mostanadInfo.meta_title
      this.mostanadData.meta_description = this.mostanadInfo.meta_description
      this.mostanadData.keywords = this.mostanadInfo.keywords != null ? this.mostanadInfo.keywords.split(',') : []
      this.seoImgSrc  = this.mostanadInfo.seo_image != null ? `${this.globalUrl}/storage/mostanadat/seo/${this.mostanadInfo.seo_image}`: ''
      this.seoImgSrc2 = this.mostanadInfo.image != null ? `${this.globalUrl}/storage/mostanadat/${this.mostanadInfo.image}`: ''
      this.videoFileSrc = this.mostanadInfo.video != null ? `${this.globalUrl}/storage/mostanadat/${this.mostanadInfo.video}`: ''
    }
  },
  props: {
    mostanadInfo: {
  ...
  methods: {
    ...
    async editMostanadData() {
      let validate = this.validateData()
      if(validate == true){
        this.loading = true
        const result = await this.$store.dispatch("edit_mostanad_data" , this.mostanadData)
