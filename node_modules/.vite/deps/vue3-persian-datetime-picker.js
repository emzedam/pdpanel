    ...
    tokenizer = new Tokenizer(stack, {
      ...
      ondirmodifier(start, end) {
        ...
        if (inVPre) {
          ...
          currentProp.modifiers.push(mod2);
        }
      },
  ...
  "node_modules/moment/moment.js"(exports, module2) {
    (function(global, factory) {
      ...
      function localeMonths2(m, format3) {
        ...
        return isArray3(this._months) ? this._months[m.month()] : this._months[(this._months.isFormat || MONTHS_IN_FORMAT2).test(format3) ? "format" : "standalone"][m.month()];
      }
      function localeMonthsShort2(m, format3) {
        if (!m) {
          return isArray3(this._monthsShort) ? this._monthsShort : this._monthsShort["standalone"];
        }
        return isArray3(this._monthsShort) ? this._monthsShort[m.month()] : this._monthsShort[MONTHS_IN_FORMAT2.test(format3) ? "format" : "standalone"][m.month()];
      }
      ...
      function localeWeekdays2(m, format3) {
        var weekdays = isArray3(this._weekdays) ? this._weekdays : this._weekdays[m && m !== true && this._weekdays.isFormat.test(format3) ? "format" : "standalone"];
      ...
      function createLocalOrUTC2(input, format3, locale3, strict, isUTC) {
        ...
        if (isObject3(input) && isObjectEmpty2(input) || isArray3(input) && input.length === 0) {
          input = void 0;
        }
      ...
      function isMomentInput2(input) {
        return isMoment2(input) || isDate2(input) || isString3(input) || isNumber2(input) || isNumberOrStringArray2(input) || isMomentInputObject2(input) || input === null || input === void 0;
      }
      ...
      "fb15": (
        ...
        function(module3, __webpack_exports__, __webpack_require__) {
          ...
          var LocaleChangevue_type_script_lang_js = {
            ...
            computed: {
              activeItem: function activeItem() {
                ...
                if (activeIndex === this.locales.length)
                  activeIndex = 0;
          ...
          var Btnvue_type_script_lang_js = {
            ...
            mounted: function mounted() {
              ...
              document.addEventListener("mouseup", function() {
                if (_this.timeout || _this.interval)
                  _this.up();
              });
            ...
            methods: {
              ...
              intervalFn: function intervalFn() {
                ...
                this.interval = window.setTimeout(function() {
                  ...
                  _this3.intervalFn();
                  if (_this3.intervalDelay > 30)
                    _this3.intervalDelay -= 3;
                }, this.intervalDelay);
              }
            }
          };
              ...
              if ((options = arguments[i]) !== null) {
                for (name in options) {
                  ...
                  if (deep && copy && (tools.isPlainObject(copy) || (copyIsArray = tools.isArray(copy)))) {
                    ...
                    target[name] = extend4(deep, clone3, copy);
                  } else if (copy !== void 0) {
                    target[name] = copy;
                  }
                }
          ...
          var addEventListener = function addEventListener2(el, type, handler) {
            ...
            if (!el)
              throw new Error("Cant find custom element: " + el);
            if (el.addEventListener)
              el.addEventListener(type, handler, true);
            else
              el.attachEvent("on" + type, handler, true);
          };
          ...
          var TimeColumnvue_type_script_lang_js = {
              ...
              selfValue: {
                handler: function handler(val, old) {
                  ...
                  this.$nextTick(function() {
                    if (_this.modelValue.toString() !== _this.selfValue.toString())
                      _this.selfValue = _this.modelValue;
                  });
                },
                immediate: true
              },
            ...
            methods: {
              ...
              onInputChange: function onInputChange(event2) {
                if (event2.target.value.length >= this.selfValue.length)
                  this.$emit("filled");
              }
            }
          };
          ...
          var TimeSectionvue_type_script_lang_js = {
            ...
            methods: {
              setTime: function setTime(v, k) {
                ...
                if (this.isLower(time))
                  time = this.minDate.clone();
                if (this.isMore(time))
                  time = this.maxDate.clone();
                this.$emit("update:time", time);
              },
              ...
              scrollIntoView: function scrollIntoView(duration) {
                ...
                try {
                  ...
                  this.$nextTick(function() {
                    ...
                    if (activeElement)
                      scrollIntoCenter(activeElement, duration, function() {
          ...
          var core_Core = function Core(defaultLocaleName, defaultOptions) {
            ...
            Instance.setLocalesConfig = function(config) {
              ...
              for (var key in config) {
                if (config.hasOwnProperty(key) && defaults2[key] === void 0)
                  defaults2[key] = utils.extend(true, {}, utils.clone(defaults2.en), {
                    lang: {
                      label: key
                    }
                  }, config[key]);
          ...
          var Vue3PersianDatetimePickervue_type_script_lang_js = {
            ...
            computed: {
              ...
              years: function years2() {
                ...
                if (!this.hasStep("y") || !isYearSectionVisible)
                  return [];
              ...
              canSubmit: function canSubmit() {
                ...
                var can = true;
                if (this.hasStep("t"))
                  can = !this.isDisableTime;
                if (can && this.type !== "time")
                  can = !this.checkDisable("d", this.date);
                return can;
              },
              ...
              visible: function visible(val) {
                ...
                if (val) {
                  ...
                  if (this.type === "datetime" && this.view === "day")
                    this.goStep("d");
                  if (this.view !== "day")
                    this.goStep(this.shortCodes[this.view] || "d");
                  this.$nextTick(function() {
                    if (_this7.appendTo) {
                      try {
            ...
            mounted: function mounted() {
              var _this9 = this;
              this.$nextTick(function() {
                if (_this9.customInputElement && !_this9.editable)
                  addLiveEvent(_this9.customInputElement, "click", _this9.focus);
                if (_this9.customInput && _this9.editable)
                  addLiveEvent(_this9.customInput, "blur", _this9.setOutput);
              });
              document.body.addEventListener("keydown", function(e) {
                e = e || event;
                var code = e.keyCode;
                if ((code === 9 || code === 27) && _this9.visible)
            ...
            methods: {
              nextStep: function nextStep(fromStep) {
                ...
                if (this.simple) {
                  if (this.type === "date" && fromStep === "day" || this.type === "year-month" && fromStep === "month" || this.type === "year" || this.type === "month")
                    checkAndSubmit();
                  return;
                }
                var step = this.step + 1;
                if (this.isCompactTime && this.type === "datetime")
                  step += 1;
              ...
              submit: function submit() {
                ...
                if (this.isCompactTime && this.type === "datetime")
                  steps -= 1;
                if (this.step < steps && !this.simple)
                ...
                if (["year", "month", "year-month"].indexOf(this.type) !== -1)
                  this.selectedDates = selected.map(function() {
              ...
              updateDates: function updateDates(payload) {
                ...
                var getDate = function getDate2(input) {
                  ...
                  try {
                    var isObject3 = Vue3PersianDatetimePickervue_type_script_lang_js_typeof(input) === "object";
                    if (input instanceof Date) {
                      date = _this13.getMoment(input);
                    } else if (input && isObject3 && "clone" in input) {
                      date = input.clone();
                    } else if (null === input || !isObject3) {
